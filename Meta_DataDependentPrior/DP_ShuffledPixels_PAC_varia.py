...
base_run_name = 'DP_ShuffledPixels' + str(n_pixels_shuffles) + '_TasksN'
...
if run_experiments:
    ...
    for i_run, n_train_tasks in enumerate(n_tasks_vec):
        call(['python', 'DP_main_Meta_Bayes.py',
              ...
              '--limit_train_samples_in_test_tasks', '0', # 2000 change to 0
              '--model-name',   'FcNet3',
              '--complexity_type',  'PAC_Bayes_variational_role', # 'NewBoundMcAllaster' 'NewBoundSeeger'
              ...
              '--data_prior_train_epochs', '2',  # default 20: training 20 epochs
              '--data_prior_test_epochs', '5', # default 20: testing 20 epochs
