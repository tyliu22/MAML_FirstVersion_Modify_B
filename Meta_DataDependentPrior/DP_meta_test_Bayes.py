...
from Meta_DataDependentPrior import DP_train_data_prior_learning
...
def run_learning(task_data, prior_model, prm, init_from_prior=True, verbose=1):
    ...
    with open(os.path.join(prm.result_dir, 'run_test_data_prior_bound_data.pkl'), 'wb') as f:
        pickle.dump({'data_objective': data_objective, "data_accuracy": data_accuracy, 'data_emp_loss': data_emp_loss,
                     'data_task_comp': data_task_comp}, f)
