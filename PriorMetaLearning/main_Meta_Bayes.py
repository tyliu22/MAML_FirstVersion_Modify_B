...
for i_task in range(n_test_tasks):
    ...
    test_err_vec[i_task], test_loss_vec[i_task], test_bound_vec[i_task], _ = meta_test_Bayes.run_learning(task_data, prior_model, prm, init_from_prior, verbose=0)
...
write_to_log('----- Meta-learner prior model paramenters: mean_list{}, std_list: {}'
